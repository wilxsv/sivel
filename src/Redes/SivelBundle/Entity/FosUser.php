...
class FosUser
{
     ...
     * Add group
     *
     * @param \Redes\SivelBundle\Entity\FosGroup $group
     * @return FosUser
     */
    public function addGroup(\Redes\SivelBundle\Entity\FosGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Redes\SivelBundle\Entity\FosGroup $group
     */
    public function removeGroup(\Redes\SivelBundle\Entity\FosGroup $group)
    {
